...
import (
  ...
  svc "github.com/the2sang/svc-panic-handling/service"
...
func main() {
  if len(os.Args) < 3 {
    log.Fatal("Specified a gRPC server and method to call")
  }
  serverAddr := os.Args[1]
  methodName := os.Args[2]

  if methodName == "GetUser" && len(os.Args) != 4 {
    log.Fatal("Specified an email address for the user")
  }
